...
class Campaign(Base, TimestampMixin):
    ...
    negotiation_policy: Mapped[dict[str, Any]] = mapped_column(JSON, default=dict)
...
class CreatorReputation(Base, TimestampMixin):
    ...
    negotiation: Mapped[float] = mapped_column(Float, default=50)
...
class Deal(Base, TimestampMixin):
    ...
    negotiation_pushes: Mapped[int] = mapped_column(Integer, default=0)
    negotiation_escalation_status: Mapped[str] = mapped_column(String(30), default="none")
    negotiation_requested_rate_cents: Mapped[int | None] = mapped_column(Integer, nullable=True)
