...
export function ActionQueue() {
  ...
  return <>
    ...
    {query.isLoading ? <LoadingState label="Loading action queue" /> : query.error ? <ErrorState message={apiErrorMessage(query.error)} retry={() => query.refetch()} /> : !query.data?.items.length ? <EmptyState title="Queue clear" detail="No operator decisions are waiting." /> : (
